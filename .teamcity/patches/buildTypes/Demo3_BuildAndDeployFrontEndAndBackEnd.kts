...
To apply the patch, create a buildType with id = 'Demo3_BuildAndDeployFrontEndAndBackEnd'
in the project with id = 'Demo3', and delete the patch script.
*/
create(RelativeId("Demo3"), BuildType({
    id("Demo3_BuildAndDeployFrontEndAndBackEnd")
    name = "Build and deploy front-end and back-end"

    vcs {
        root(RelativeId("Demo3_HttpsGithubComTarasKindratDemo2gitRefsHeadsMaster"))
    }
